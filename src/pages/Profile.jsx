...
const ProfilePage = () => {
  ...
  // Shared CSS classes
  const cardBase =
    "bg-black/30 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-500/30 hover:border-purple-400/50 transition-all duration-500";
  const gradientText =
    "bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent";
  const iconContainer =
    "p-3 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl backdrop-blur-sm border border-purple-400/30";
        ...
        <div className={`${cardBase} py-6`}>
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="relative">
              ...
              <div className="absolute -top-2 -right-2 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full p-2 shadow-xl shadow-pink-500/50">
            ...
            <div className="text-center lg:text-left flex-1">
              <h1
                className={`text-3xl sm:text-4xl font-bold ${gradientText} mb-3`}
              >
                Bozes Baraka
              </h1>
            ...
            <div className="text-center relative">
              <div className={`text-4xl font-bold ${gradientText} mb-2`}>
                {levelInfo.level}
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          ...
          <div className="xl:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div
                className={`${cardBase} p-6 hover:scale-105 group cursor-pointer`}
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`${iconContainer} group-hover:scale-110 transition-transform duration-300`}
                  >
            ...
            <div className={cardBase + " p-8"}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="text-center p-6 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl backdrop-blur-sm border border-purple-400/30 hover:border-purple-300/50 transition-all duration-300 hover:scale-105 group">
                  <div
                    className={`text-4xl font-bold ${gradientText} mb-3 group-hover:scale-110 transition-transform duration-300`}
                  >
                    {averageScore}%
                  </div>
...
// This is a simple optimization to avoid unnecessary re-renders
// since the Profile component doesn't depend on any props or state that change frequently.
// You can further optimize by using useMemo or useCallback for any derived values or functions if