...
const BottomNav = () => {
  ...
  return (
    <div>
      ...
      <div className="fixed z-20 bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-3xl bg-gradient-to-r from-purple-950 to-slate-900  backdrop-blur-xl border-t border-purple-500/20 lg:hidden">
