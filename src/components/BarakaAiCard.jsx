...
export default function BarakaAICard() {
  ...
  return (
    <div onClick={()=>navigate("/baraka-ai")}>
      ...
      <div className="bg-gradient-to-br from-purple-600/25 to-pink-600/25 backdrop-blur-lg border border-purple-400/40 rounded-2xl p-4 sm:p-6 hover:scale-105 lg:hover:scale-102 transition-all duration-300 cursor-pointer w-full shadow-xl shadow-purple-900/20">
        ...
        <button onClick={()=>navigate("/baraka-ai")} className="bg-black/40 text-purple-400 text-sm font-medium shadow-lg shadow-black/30 py-2 px-3 rounded-md ring ring-purple-600 absolute top-2 right-2 ">Chat with my Ai </button>
      </div>
    </div>
  );
}
