...
import questionsData from "./DataQuiz.json";
...
const DataQuiz = () => {
  ...
  const [percentageScore, setPercentageScore] = useLocalStorage(
    "data-percentage-score",
    0
  );
  const [savedScore, setSavedScore] = useLocalStorage("data-quiz-points", 0);
  ...
  // Set quizLengh
  const [quizLength, setQuizLength] = useLocalStorage("data-quiz-length", null);
    ...
    <div className=" text-white p-4">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-slate-800/60 backdrop-blur-lg p-8 rounded-3xl shadow-2xl border border-purple-500/30 relative overflow-hidden">
          ...
          {showAnswer && (
            <div className="mb-6 p-4 absolute min-w-56  top-5 left-1/2 transform -translate-x-1/2   bg-gradient-to-r from-purple-700/60 to-pink-700/60 backdrop-blur-sm">
              <div className="flex items-center">
